...
/**
 * Represents the application's conquer recap page.
 */
@Component({
    selector: 'app-conquer-recap',
    imports: [ GameRecapComponent, DatePipe ],
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './conquer-recap.component.html',
    styleUrl: '../game-recap.css'
})
export class ConquerRecapComponent extends BaseLayout {
    // Fields ---------------------------------------------------------------------
    ...
    /**
     * Creates a new ConquerRecapComponent object.
     *
